    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escritor', models.TextField(blank=True, max_length=200, null=True)),
                ('atores', models.TextField(blank=True, max_length=200, null=True)),
                ('duracao', models.TimeField(blank=True, null=True)),
                ('classificacao', models.CharField(blank=True, choices=[('Livre', 'Livre'), ('10', '10'), ('12', '12'), ('14', '14'), ('16', '16'), ('18', '18')], max_length=20, null=True)),
                ('sinopse', models.TextField(blank=True, max_length=400, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membros', models.ManyToManyField(blank=True, related_name='membros', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escritor', models.TextField(blank=True, max_length=200, null=True)),
                ('atores', models.TextField(blank=True, max_length=200, null=True)),
                ('classificacao', models.CharField(choices=[('Livre', 'Livre'), ('10', '10'), ('12', '12'), ('14', '14'), ('16', '16'), ('18', '18')], max_length=20)),
                ('data', models.DateField(blank=True, null=True)),
